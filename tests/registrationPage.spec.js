...
test.describe('რეგისტრაცია', () => {
  ...
  test('რეგისტრაცია - მცდარი მონაცემები', async ({ page }) => {
  
    // Registration Page
    await CommonMethods.openWebPage(page, 'https://id.rebank.ge/Account/Register');
  ...
  test('ავტორიზაცია - ერთი შევსებული ველით (მობილური)', async ({ page }) => {
  ...
  test('ავტორიზაცია - ერთი შევსებული ველით (პირადი ნომერი)', async ({ page }) => {
  ...
  test('ავტორიზაცია - ერთი შევსებული ველით (ელ. ფოსტა)', async ({ page }) => {
  ...
  test('ავტორიზაცია - ორი შევსებული ველით (მობილური - პირადი ნომერი)', async ({ page }) => {
  ...
  test('ავტორიზაცია - ორი შევსებული ველით (მობილური - ელ. ფოსტა)', async ({ page }) => {
  ...
  test('ავტორიზაცია - ორი შევსებული ველით (პირადი ნომერი - ელ. ფოსტა)', async ({ page }) => {
